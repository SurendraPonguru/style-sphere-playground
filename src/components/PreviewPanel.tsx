...
const PreviewPanel: React.FC<PreviewPanelProps> = ({ currentTheme, isDarkMode }) => {
  ...
  return (
    <div className={`h-full w-full ${currentTheme.className} bg-gradient-to-br from-card/80 to-card preview-container`}>
      <div className="preview-card h-full preview-content">
        <div className="text-center mb-4 animation-reveal">
          <h1 className="text-xl font-bold mb-1 relative inline-block">
            Preview Panel
        ...
        <Tabs defaultValue="elements" value={activeTab} onValueChange={handleTabChange} className="h-full-export">
          <TabsList className="grid grid-cols-4 mb-4 bg-background/80 backdrop-blur-sm p-1 rounded-full">
            <TabsTrigger 
              value="elements" 
          ...
          <div className="tab-content-container overflow-y-auto h-[calc(100%-50px)]">
            <TabsContent value="elements" className="space-y-6 animation-reveal p-2">
            ...
            <TabsContent value="components" className="space-y-6 animation-reveal p-2">
              <div className="space-y-4">
            ...
            <TabsContent value="animations" className="space-y-6 animation-reveal p-2">
              <div className="space-y-4">
            ...
            <TabsContent value="draggable" className="animation-reveal p-2">
              <div className="mb-6">
